...
static INLINE CONST vdouble VECTOR_CC vupper_vd_vd(vdouble d) {
  return vreinterpret_vd_vm(vand_vm_vm_vm(vreinterpret_vm_vd(d), vcast_vm_i_i(0xffffffff, 0xf8000000)));
}

static INLINE CONST vdouble2 VECTOR_CC vcast_vd2_vd_vd(vdouble h, vdouble l) {
  vdouble2 ret = {h, l};
  return ret;
}

static INLINE CONST vdouble2 VECTOR_CC vcast_vd2_d_d(double h, double l) {
  vdouble2 ret = {vcast_vd_d(h), vcast_vd_d(l)};
  return ret;
}

static INLINE CONST vdouble2 VECTOR_CC vsel_vd2_vo_vd2_vd2(vopmask m, vdouble2 x, vdouble2 y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC vsel_vd2_vo_d_d_d_d(vopmask o, double x1, double y1, double x0, double y0) {
  vdouble2 r;
...
static INLINE CONST vdouble VECTOR_CC vadd_vd_3vd(vdouble v0, vdouble v1, vdouble v2) {
  return vadd_vd_vd_vd(vadd_vd_vd_vd(v0, v1), v2);
}

static INLINE CONST vdouble VECTOR_CC vadd_vd_4vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3) {
  return vadd_vd_3vd(vadd_vd_vd_vd(v0, v1), v2, v3);
}

static INLINE CONST vdouble VECTOR_CC vadd_vd_5vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3, vdouble v4) {
  return vadd_vd_4vd(vadd_vd_vd_vd(v0, v1), v2, v3, v4);
}

static INLINE CONST vdouble VECTOR_CC vadd_vd_6vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3, vdouble v4, vdouble v5) {
  return vadd_vd_5vd(vadd_vd_vd_vd(v0, v1), v2, v3, v4, v5);
}

static INLINE CONST vdouble VECTOR_CC vadd_vd_7vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3, vdouble v4, vdouble v5, vdouble v6) {
  return vadd_vd_6vd(vadd_vd_vd_vd(v0, v1), v2, v3, v4, v5, v6);
}

static INLINE CONST vdouble VECTOR_CC vsub_vd_3vd(vdouble v0, vdouble v1, vdouble v2) {
  return vsub_vd_vd_vd(vsub_vd_vd_vd(v0, v1), v2);
}

static INLINE CONST vdouble VECTOR_CC vsub_vd_4vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3) {
  return vsub_vd_3vd(vsub_vd_vd_vd(v0, v1), v2, v3);
}

static INLINE CONST vdouble VECTOR_CC vsub_vd_5vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3, vdouble v4) {
  return vsub_vd_4vd(vsub_vd_vd_vd(v0, v1), v2, v3, v4);
}

static INLINE CONST vdouble VECTOR_CC vsub_vd_6vd(vdouble v0, vdouble v1, vdouble v2, vdouble v3, vdouble v4, vdouble v5) {
  return vsub_vd_5vd(vsub_vd_vd_vd(v0, v1), v2, v3, v4, v5);
}

//

static INLINE CONST vdouble2 VECTOR_CC ddneg_vd2_vd2(vdouble2 x) {
  return vcast_vd2_vd_vd(vneg_vd_vd(x.x), vneg_vd_vd(x.y));
}

static INLINE CONST vdouble2 VECTOR_CC ddabs_vd2_vd2(vdouble2 x) {
...
static INLINE CONST vdouble2 VECTOR_CC ddnormalize_vd2_vd2(vdouble2 t) {
  vdouble2 s;
...
static INLINE CONST vdouble2 VECTOR_CC ddscale_vd2_vd2_vd(vdouble2 d, vdouble s) {
  vdouble2 r = {vmul_vd_vd_vd(d.x, s), vmul_vd_vd_vd(d.y, s)};
  return r;
}

static INLINE CONST vdouble2 VECTOR_CC ddadd_vd2_vd_vd(vdouble x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd2_vd2_vd_vd(vdouble x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd_vd2_vd2_vd(vdouble2 x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddsub_vd2_vd2_vd(vdouble2 x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd2_vd2_vd2_vd(vdouble2 x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd_vd2_vd_vd2(vdouble x, vdouble2 y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd2_vd2_vd_vd2(vdouble x, vdouble2 y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddadd_vd2_vd2_vd2(vdouble2 x, vdouble2 y) {
  // |x| >= |y|
...
static INLINE CONST vdouble2 VECTOR_CC ddadd2_vd2_vd2_vd2(vdouble2 x, vdouble2 y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddsub_vd2_vd_vd(vdouble x, vdouble y) {
  // |x| >= |y|
...
static INLINE CONST vdouble2 VECTOR_CC ddsub_vd2_vd2_vd2(vdouble2 x, vdouble2 y) {
  // |x| >= |y|
...
#ifdef ENABLE_FMA_DP
static INLINE CONST vdouble2 VECTOR_CC dddiv_vd2_vd2_vd2(vdouble2 n, vdouble2 d) {
  vdouble2 q;
...
static INLINE CONST vdouble2 VECTOR_CC ddmul_vd2_vd_vd(vdouble x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddsqu_vd2_vd2(vdouble2 x) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddmul_vd2_vd2_vd2(vdouble2 x, vdouble2 y) {
  vdouble2 r;
...
static INLINE CONST vdouble VECTOR_CC ddmul_vd_vd2_vd2(vdouble2 x, vdouble2 y) {
  return vfma_vd_vd_vd_vd(x.x, y.x, vfma_vd_vd_vd_vd(x.y, y.x, vmul_vd_vd_vd(x.x, y.y)));
}

static INLINE CONST vdouble VECTOR_CC ddsqu_vd_vd2(vdouble2 x) {
  return vfma_vd_vd_vd_vd(x.x, x.x, vadd_vd_vd_vd(vmul_vd_vd_vd(x.x, x.y), vmul_vd_vd_vd(x.x, x.y)));
}

static INLINE CONST vdouble2 VECTOR_CC ddmul_vd2_vd2_vd(vdouble2 x, vdouble y) {
  vdouble2 r;
...
static INLINE CONST vdouble2 VECTOR_CC ddrec_vd2_vd(vdouble d) {
  vdouble2 q;
...
static INLINE CONST vdouble2 VECTOR_CC ddrec_vd2_vd2(vdouble2 d) {
  vdouble2 q;
...
static INLINE CONST vdouble2 VECTOR_CC ddsqrt_vd2_vd2(vdouble2 d) {
...
static INLINE CONST vdouble2 VECTOR_CC ddsqrt_vd2_vd(vdouble d) {
