...
#endif
static INLINE CONST vfloat VECTOR_CC vupper_vf_vf(vfloat d) {
  return vreinterpret_vf_vi2(vand_vi2_vi2_vi2(vreinterpret_vi2_vf(d), vcast_vi2_i(0xfffff000)));
}

static INLINE CONST vfloat2 VECTOR_CC vcast_vf2_vf_vf(vfloat h, vfloat l) {
  vfloat2 ret = {h, l};
  return ret;
}

static INLINE CONST vfloat2 VECTOR_CC vcast_vf2_f_f(float h, float l) {
  vfloat2 ret = {vcast_vf_f(h), vcast_vf_f(l)};
  return ret;
}

static INLINE CONST vfloat2 VECTOR_CC vcast_vf2_d(double d) {
  vfloat2 ret = {vcast_vf_f(d), vcast_vf_f(d - (float)d)};
  return ret;
}

static INLINE CONST vfloat2 VECTOR_CC vsel_vf2_vo_vf2_vf2(vopmask m, vfloat2 x, vfloat2 y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC vsel_vf2_vo_f_f_f_f(vopmask o, float x1, float y1, float x0, float y0) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC vsel_vf2_vo_vo_d_d_d(vopmask o0, vopmask o1, double d0, double d1, double d2) {
  return vsel_vf2_vo_vf2_vf2(o0, vcast_vf2_d(d0), vsel_vf2_vo_vf2_vf2(o1, vcast_vf2_d(d1), vcast_vf2_d(d2)));
}

static INLINE CONST vfloat2 VECTOR_CC vsel_vf2_vo_vo_vo_d_d_d_d(vopmask o0, vopmask o1, vopmask o2, double d0, double d1, double d2, double d3) {
...
static INLINE CONST vfloat2 VECTOR_CC vabs_vf2_vf2(vfloat2 x) {
...
static INLINE CONST vfloat VECTOR_CC vadd_vf_3vf(vfloat v0, vfloat v1, vfloat v2) {
  return vadd_vf_vf_vf(vadd_vf_vf_vf(v0, v1), v2);
}

static INLINE CONST vfloat VECTOR_CC vadd_vf_4vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3) {
  return vadd_vf_3vf(vadd_vf_vf_vf(v0, v1), v2, v3);
}

static INLINE CONST vfloat VECTOR_CC vadd_vf_5vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3, vfloat v4) {
  return vadd_vf_4vf(vadd_vf_vf_vf(v0, v1), v2, v3, v4);
}

static INLINE CONST vfloat VECTOR_CC vadd_vf_6vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3, vfloat v4, vfloat v5) {
  return vadd_vf_5vf(vadd_vf_vf_vf(v0, v1), v2, v3, v4, v5);
}

static INLINE CONST vfloat VECTOR_CC vadd_vf_7vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3, vfloat v4, vfloat v5, vfloat v6) {
  return vadd_vf_6vf(vadd_vf_vf_vf(v0, v1), v2, v3, v4, v5, v6);
}

static INLINE CONST vfloat VECTOR_CC vsub_vf_3vf(vfloat v0, vfloat v1, vfloat v2) {
  return vsub_vf_vf_vf(vsub_vf_vf_vf(v0, v1), v2);
}

static INLINE CONST vfloat VECTOR_CC vsub_vf_4vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3) {
  return vsub_vf_3vf(vsub_vf_vf_vf(v0, v1), v2, v3);
}

static INLINE CONST vfloat VECTOR_CC vsub_vf_5vf(vfloat v0, vfloat v1, vfloat v2, vfloat v3, vfloat v4) {
  return vsub_vf_4vf(vsub_vf_vf_vf(v0, v1), v2, v3, v4);
}

//

static INLINE CONST vfloat2 VECTOR_CC dfneg_vf2_vf2(vfloat2 x) {
  return vcast_vf2_vf_vf(vneg_vf_vf(x.x), vneg_vf_vf(x.y));
}

static INLINE CONST vfloat2 VECTOR_CC dfabs_vf2_vf2(vfloat2 x) {
...
static INLINE CONST vfloat2 VECTOR_CC dfnormalize_vf2_vf2(vfloat2 t) {
  vfloat2 s;
...
static INLINE CONST vfloat2 VECTOR_CC dfscale_vf2_vf2_vf(vfloat2 d, vfloat s) {
  vfloat2 r = {vmul_vf_vf_vf(d.x, s), vmul_vf_vf_vf(d.y, s)};
  return r;
}

static INLINE CONST vfloat2 VECTOR_CC dfadd_vf2_vf_vf(vfloat x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd2_vf2_vf_vf(vfloat x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd2_vf2_vf_vf2(vfloat x, vfloat2 y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd_vf2_vf2_vf(vfloat2 x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfsub_vf2_vf2_vf(vfloat2 x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd2_vf2_vf2_vf(vfloat2 x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd_vf2_vf_vf2(vfloat x, vfloat2 y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfadd_vf2_vf2_vf2(vfloat2 x, vfloat2 y) {
  // |x| >= |y|
...
static INLINE CONST vfloat2 VECTOR_CC dfadd2_vf2_vf2_vf2(vfloat2 x, vfloat2 y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfsub_vf2_vf_vf(vfloat x, vfloat y) {
  // |x| >= |y|
...
static INLINE CONST vfloat2 VECTOR_CC dfsub_vf2_vf2_vf2(vfloat2 x, vfloat2 y) {
  // |x| >= |y|
...
#ifdef ENABLE_FMA_SP
static INLINE CONST vfloat2 VECTOR_CC dfdiv_vf2_vf2_vf2(vfloat2 n, vfloat2 d) {
  vfloat2 q;
...
static INLINE CONST vfloat2 VECTOR_CC dfmul_vf2_vf_vf(vfloat x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfsqu_vf2_vf2(vfloat2 x) {
  vfloat2 r;
...
static INLINE CONST vfloat VECTOR_CC dfsqu_vf_vf2(vfloat2 x) {
  return vfma_vf_vf_vf_vf(x.x, x.x, vadd_vf_vf_vf(vmul_vf_vf_vf(x.x, x.y), vmul_vf_vf_vf(x.x, x.y)));
}

static INLINE CONST vfloat2 VECTOR_CC dfmul_vf2_vf2_vf2(vfloat2 x, vfloat2 y) {
  vfloat2 r;
...
static INLINE CONST vfloat VECTOR_CC dfmul_vf_vf2_vf2(vfloat2 x, vfloat2 y) {
  return vfma_vf_vf_vf_vf(x.x, y.x, vfma_vf_vf_vf_vf(x.y, y.x, vmul_vf_vf_vf(x.x, y.y)));
}

static INLINE CONST vfloat2 VECTOR_CC dfmul_vf2_vf2_vf(vfloat2 x, vfloat y) {
  vfloat2 r;
...
static INLINE CONST vfloat2 VECTOR_CC dfrec_vf2_vf(vfloat d) {
  vfloat2 q;
...
static INLINE CONST vfloat2 VECTOR_CC dfrec_vf2_vf2(vfloat2 d) {
  vfloat2 q;
...
static INLINE CONST vfloat2 VECTOR_CC dfsqrt_vf2_vf2(vfloat2 d) {
...
static INLINE CONST vfloat2 VECTOR_CC dfsqrt_vf2_vf(vfloat d) {
